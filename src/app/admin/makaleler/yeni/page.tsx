  ...
  return (
    <div className="space-y-6">
      ...
      <div className="flex items-center gap-4">
        ...
        <div>
          <h2 className="font-heading text-2xl font-bold text-primary">Yeni Makale</h2>
          <p className="text-gray-500 font-body text-sm mt-1">Yeni bir makale oluşturun</p>
        </div>
      </div>
            ...
            <div className="bg-white rounded-lg shadow-sm p-6 space-y-5">
              ...
              <div>
                ...
                <input
                  type="text"
                  {...register("slug")}
                  className="w-full px-4 py-2.5 border border-gray-200 rounded-lg focus:outline-none focus:ring-2 focus:ring-gold/50 focus:border-gold font-body text-sm bg-gray-50"
